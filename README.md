...
It is a string of cryptic text stored on the client-side local storage that reminds the server who you are and what permissions you have to access its data.

- [ ] What steps can you take in your web apps to keep your data secure?

You can build them in a way that requires registration and log in so that only authorized users can access their information.  

- [ ] Describe how web servers work.

Web servers host websites/apps by storing code for them as they are connected to the internet. They serve or deliver web pages retrieved from that code upon request to their specific URL and domain name.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

Create - PUT/POST; Read - GET; Update - PUT/POST/PATCH; Delete - DELETE
